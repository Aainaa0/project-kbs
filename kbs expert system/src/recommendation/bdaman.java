...
public class bdaman extends JFrame {
	...
	public bdaman() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/b-daman.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt0455244/?ref_=fn_tt_tt_6");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt0455244/?ref_=fn_tt_tt_6"));
					   }
