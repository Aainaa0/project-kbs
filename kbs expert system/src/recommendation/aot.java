...
public class aot extends JFrame {
	...
	public aot() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/aot.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt2560140/?ref_=kw_li_tt");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt2560140/?ref_=kw_li_tt"));
					   }
