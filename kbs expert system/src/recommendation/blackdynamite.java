...
public class blackdynamite extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					blackdynamite frame = new blackdynamite();
	...
	public blackdynamite() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/blackdynamite.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt1608383/?ref_=fn_al_tt_2");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt1608383/?ref_=fn_al_tt_2"));
					   }
