...
public class oremonogatari extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					oremonogatari frame = new oremonogatari();
	...
	public oremonogatari() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/oremonogatari.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt4616700/?ref_=fn_tt_tt_1");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt4616700/?ref_=fn_tt_tt_1"));
					   }
