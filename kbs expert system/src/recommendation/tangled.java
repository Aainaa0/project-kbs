...
public class tangled extends JFrame {
	...
	public tangled() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/tangled.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt0398286/?ref_=fn_al_tt_1");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt0398286/?ref_=fn_al_tt_1"));
					   }
