...
public class chowder extends JFrame {
	...
	public chowder() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/chowder.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt1140100/?ref_=fn_al_tt_1");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt1140100/?ref_=fn_al_tt_1"));
					   }
