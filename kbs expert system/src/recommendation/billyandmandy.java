...
public class billyandmandy extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					billyandmandy frame = new billyandmandy();
	...
	public billyandmandy() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/billyandmandy.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt0292800/?ref_=fn_al_tt_3");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt0292800/?ref_=fn_al_tt_3"));
					   }
