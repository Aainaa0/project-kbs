...
public class erased extends JFrame {
	...
	public erased() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/erased.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt5249462/?ref_=tt_sims_tt");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt5249462/?ref_=tt_sims_tt"));
					   }
