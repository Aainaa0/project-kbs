...
public class dcblue extends JFrame {
	...
	public dcblue() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/dcblue.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt9501310/?ref_=nv_sr_srsg_0");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt9501310/?ref_=nv_sr_srsg_0"));
					   }
