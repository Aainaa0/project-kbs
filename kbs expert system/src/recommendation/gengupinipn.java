...
public class gengupinipn extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					gengupinipn frame = new gengupinipn();
	...
	public gengupinipn() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/gengupinipn.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt9894394/?ref_=fn_tt_tt_2");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt9894394/?ref_=fn_tt_tt_2"));
					   }
