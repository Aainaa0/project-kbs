...
public class ejenali extends JFrame {
	...
	public ejenali() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/ejenali.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt9020536/?ref_=fn_al_tt_1");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt9020536/?ref_=fn_al_tt_1"));
					   }
