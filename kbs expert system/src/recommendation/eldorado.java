...
public class eldorado extends JFrame {
	...
	public eldorado() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/eldorado.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt0138749/?ref_=adv_li_tt");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt0138749/?ref_=adv_li_tt"));
					   }
