...
public class spongebobmovie extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					spongebobmovie frame = new spongebobmovie();
	...
	public spongebobmovie() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/spongebobmovie.jpg")).getImage().getScaledInstance(182, 261,Image.SCALE_DEFAULT);
		...
		btnLink.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				openWebPage("https://www.imdb.com/title/tt0345950/?ref_=fn_al_tt_1");
			}

			private void openWebPage(String string) {
				   try {         
					     java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.imdb.com/title/tt0345950/?ref_=fn_al_tt_1"));
					   }
